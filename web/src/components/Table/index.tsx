import { ArrowClockwise, SmileyXEyes, Trash } from "phosphor-react";
        ...
        {Object.entries(feedbacks).map(([key, value]) => {
          return (
            ...
            >
              ...
              <td className="text-xl font-light w-52 h-20 p-2">
                <textarea
                  className="text-sm rounded-md placeholder-zinc-400 text-zinc-300 border border-solid bg-zinc-900 border-brand-500 ring-brand-500 ring-1 outline-none resize-none scrollbar-thumb-zinc-700 scrollbar-track-transparent scrollbar-thin cursor-text"
                  disabled
                >
                  {value.comment}
                </textarea>
